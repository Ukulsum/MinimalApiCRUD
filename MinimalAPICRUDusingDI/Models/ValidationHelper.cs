...
namespace MinimalAPICRUDusingDI.Models
{
    ...
    {
        // TryValidate mathod performs validation on a generic model object.
        // 'T' represents any type which means this method can be used with any model.
        public static bool TryValidate<T>(T model, out List<ValidationResult> validateResults)
        {
            ...
            validateResults = new List<ValidationResult>();
            ...
            return Validator.TryValidateObject(model, validationContext, validateResults,true);
        }
    }
}
